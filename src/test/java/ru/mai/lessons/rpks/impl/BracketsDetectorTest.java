...
public class BracketsDetectorTest {
  ...
  @Test(description = "Успешная проверка расстановки всех возможных скобок. Не должны найти "
                      + "ошибки.")
  void testPositiveCheckAllBracketsRules() throws JsonParseException {
    // GIVEN
  ...
  void testPositiveCheckSomeBracketsRules(String config, List<String> content) throws JsonParseException {
    // WHEN
  ...
  void testNegativeCheckAllBracketsRules(List<String> content,
                                         List<ErrorLocationPoint> expectedErrors) throws JsonParseException {
    // WHEN
  ...
  @Test(description = "Успешная проверка расстановки указанных в конфиге скобок. Не должны найти "
                      + "ошибки.")
  void testPositiveCheckMagicBracketsRules() throws JsonParseException {
    // GIVEN
  ...
  void testNegativeCheckMagicBracketsRules() throws JsonParseException {
    // GIVEN
    List<String> content = List.of("{}",
                                   "()",
                                   "){");
